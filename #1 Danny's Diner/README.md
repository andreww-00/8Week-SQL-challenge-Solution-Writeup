...
Danny opened a resuranut that sells sushi, curry, and ramen. Danny has collected some basic data over the past two months and needs help developing data driven insights.
# Problem Statement:
